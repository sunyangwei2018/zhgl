...
YDIMPL.define({
	"query" : function(){
		var YD = YDIMPL.getPlugin()["YD"];
		YDIMPL.reloadPlugin("YD",YD);
	},
...
YDIMPL.setEvents(function() {
	YDIMPL.getTab().delegate("#XZMB", "click",function(event){
		var json ={};
		var XmlData={"filename":"运单导入","keys":{"billno":"*运单号","cus_code":"*客户代码(编码)","cusno":"客户单号","postdate":"*托运日期","postzone":"*始发地(编码)",
