...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_968,/*keydown:_96c,-old*/keyup:_96c,paste:_96c,drop:_96c},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
//syw_add 2016-6-26
var item=_9c9.children("div.combobox-item.combobox-item-selected:contains('"+t.combobox("getText")+"')").eq(0);
if(item.length){
...
//syw_add 2016-6-16
//var id=(_9e4==-1?$(_9e2).combobox("panel").children("div.combobox-item:contains('"+_9e3+"')").attr("id"):($.data(_9e2,"combobox").itemIdPrefix+"_"+_9e4));
if(_9e3==""){
	var id=$.data(_9e2,"combobox").itemIdPrefix+"_"+_9e4;
}else{
	var id=ui.isNull($(_9e2).combobox("panel").children("div.combobox-item:contains('"+_9e3+"')").attr("id"))?$.data(_9e2,"combobox").itemIdPrefix+"_"+_9e4:$(_9e2).combobox("panel").children("div.combobox-item:contains('"+_9e3+"')").attr("id");
}
return $("#"+id);
