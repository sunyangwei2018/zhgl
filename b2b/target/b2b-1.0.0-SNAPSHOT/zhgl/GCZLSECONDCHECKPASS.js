...
GCZLSECONDCHECKPASS.setEvents(function(){
	...
	GCZLSECONDCHECKPASS.getTab().find("#jxs").textbox('clear');
	GCZLSECONDCHECKPASS.getTab().find("#jxs").textbox('setValue', userInfo.KHGSID);
	GCZLSECONDCHECKPASS.getTab().find("#jxs").textbox('setText', userInfo.KHNAMEJC);
