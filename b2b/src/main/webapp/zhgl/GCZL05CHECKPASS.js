...
GCZL05CHECKPASS.setEvents(function(){
	...
	GCZL05CHECKPASS.getTab().find("#dls").textbox('clear');
	GCZL05CHECKPASS.getTab().find("#dls").textbox('setValue', userInfo.SJKHGSID);
	GCZL05CHECKPASS.getTab().find("#dls").textbox('setText', userInfo.SJKHNAMEJC);
...
GCZL05CHECKPASS.setAfterInit(function() { 
	...
	if(!ui.isNull(GCZL05CHECKPASS.getData().bizKey)){
		...
		GCZL05CHECKPASS.getTab().find("#dls").textbox("setText",resultData["SJKHGSID"])
		GCZL05CHECKPASS.getTab().find("#dls").textbox("setText",resultData["SJKHGSNAME"])
